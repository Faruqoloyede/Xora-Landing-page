    ...
    <section className='relative z-2 py-24 md:py-28 lg:py-40'>
      <div className="container block lg:flex">
        <div className='testimonials_head-res relative z-2 mr-20 flex-300'>
          ...
          <h3 className="h3 max-md:h5 text-p4">Words from fans</h3>
        </div>
        <div className="testimonials_inner-after testimonials_inner-before relative -my-13 -mr-3 flex items-start max-lg:static max-md:block">
