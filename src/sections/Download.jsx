...
const Download = () => {
  return (
    <section>
        <Element name='download' className='g7 relative pb-2 pt-24 max-lg:pb-24 max-md:py-16'>
            <div className="container">
                <div className='flex items-center'>
                        ...
                        {links.map(({ id, url, icon })=>(
                            <li key={id} className='download_tech-link download_tech-link_last-before download_tech-link_last-after'>
                                <a href={url} className='size-22 download_tech-icon_before relative flex items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500'>
                                    ...
                                    <img src={"/images/lines.svg"} alt="line" className='absolute size-13/20 object-contain' />
                    ...
                    <div className="mb-10max-md:hidden">
                        <div className="download_preview-before download_preview-after relative rounded-40 w-[955px] border-2 border-s5 p-6">
                            <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                                ...
                                <img src="/images/screen.jpg" alt="demo" height={655} width={855} className='rounded-xl'  />
                            </div>
                        </div>
                    </div>
                </div>
